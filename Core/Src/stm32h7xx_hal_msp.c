...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(ICM20948_SCK_GPIO_Port, ICM20948_SCK_Pin);

    HAL_GPIO_DeInit(ICM20948_MISO_GPIO_Port, ICM20948_MISO_Pin);

    HAL_GPIO_DeInit(ICM20948_MOSI_GPIO_Port, ICM20948_MOSI_Pin);
